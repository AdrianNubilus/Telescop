...
<?php echo $content_top; ?>
  ...
  <div class="record-info" style="padding: 0; margin: 0; border-bottom:1px solid #DDDDDD;">
...
<ins class="hrefajax"><?php echo $this->language->get('text_signer'); ?></ins>
</label>
</form>
...
<a class="textdecoration_none" onclick="$('a[href=\'#tab-comment\']').trigger('click');" href="<?php echo $href; ?>#comment-title"><ins class="fontsize_15 hrefajax textdecoration_none"><?php echo $this->language->get('text_write_review'); ?></ins></a>
    ...
    <a href="#" onclick="comment_reply('0'); return false;" id="comment_id_reply_0" class="comment_buttons">
	    <div id="comment-title"><ins id="reply_0"><?php echo $this->language->get('text_write'); ?></ins></div>
    </a>
...
<?php } ?>
  ...
  <?php if ($products) { ?>
  <div id="tab-product-related" class="tab-content" style="width:100%;">

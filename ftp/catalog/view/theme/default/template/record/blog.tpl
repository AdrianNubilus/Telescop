...
?>"></a>
 ...
 <div class="blog-divider"></div>
  ...
  <div class="blog-record-list">
    ...
    <div>
     <div class="name marginbottom5" style="padding-top:10px;">
 <!--    <?php if (isset ($record['settings']['category_status']) && $record['settings']['category_status'] ) { ?>
    ...
    <noindex><a href="<?php echo $record['blog_href']; ?>" class="blog-title" rel="nofollow"><?php echo $record['blog_name']; ?></a></noindex><ins class="blog-arrow">&nbsp;&rarr;&nbsp;</ins>
    <?php } ?>
    <?php } ?>
-->

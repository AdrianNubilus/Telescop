  ...
  <div class="product-info">
    ...
    <div class="right">
      <div class="description">
        <?php if ($manufacturer) { ?>
        <span><?php echo $text_manufacturer; ?></span> <!--<a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a> --><?php echo $manufacturer; ?><br />
        <?php } ?>
	...
	<?php if (isset($jvquickorder_status) && ($jvquickorder_status) ) { ?>
	    &nbsp;<a onclick="jv_qiuckorder_show('<?php echo $product_id; ?>');" class="button"><span><?php echo $button_jv_quick_order; ?></span></a> 
	<?php } ?>
	<!-- JV_Quick_Order -->
...
<!--	<div class="add-smm">Social-media buttons</div> -->
...
<?php if ($review_status) { ?>
  ...
  <?php } ?>
  <?php if ($products) { ?>
  <div id="tab-related" class="tab-content" style="display:block; float:right; border-top:1px solid #DDDDDD;">
  <h3>С этим телескопом часто покупают:</h3>
    <div class="box-product">
      <?php foreach ($products as $product) { ?>
      <div style="margin-right:-5px; width:240px; padding-bottom:40px;">
